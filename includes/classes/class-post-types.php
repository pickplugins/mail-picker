...
class class_mail_picker_post_types
{
    ...
    public function _posttype_subscriber()
    {
        ...
        register_taxonomy(
            "subscriber_list",
            apply_filters('register_taxonomy_list_object_type', array('subscriber')),
            apply_filters('register_taxonomy_list_args', array(
                'hierarchical'             => true,
    ...
    public function _posttype_subscriber_form()
    {
        ...
        register_post_type(
            "subscriber_form",
            apply_filters(
                "register_post_type_subscriber_form",
                array(
                    'labels' => array(
                        'name'                     => $plural,
                        'singular_name'         => $singular,
    ...
    public function _posttype_subscriber_source()
    {
        ...
        register_post_type(
            "subscriber_source",
            apply_filters(
                "register_post_type_subscriber_source",
                array(
                    'labels' => array(
                        'name'                     => $plural,
                        'singular_name'         => $singular,
    ...
    public function _posttype_mail_template()
    {
        ...
        register_post_type(
            "mail_template",
            apply_filters(
                "register_post_type_mail_template",
                array(
                    'labels' => array(
                        'name'                     => $plural,
                        'singular_name'         => $singular,
    ...
    public function _posttype_mail_campaign()
    {
        ...
        register_post_type(
            "mail_campaign",
            apply_filters(
                "register_post_type_mail_campaign",
                array(
                    'labels' => array(
                        'name'                     => $plural,
                        'singular_name'         => $singular,
    ...
    public function _posttype_sms_campaign()
    {
        ...
        register_post_type(
            "sms_campaign",
            apply_filters(
                "register_post_type_sms_campaign",
                array(
                    'labels' => array(
                        'name'                     => $plural,
                        'singular_name'         => $singular,
