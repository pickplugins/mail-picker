...
?>
            ...
            <div class="section">
                ...
                <div class="setting-field ">
                    ...
                    $elements_group['general'] = array(
                        'group_title' => 'General',
                        'items' => array(
                            'email' => array('name' => __('Subscriber email', 'mail-picker')),
    ...
    ?>
        <div class="settings-tabs">
            ...
            <div class="setting-field">
                ...
                <div class="field-input">
                    <input id="email" placeholder="" class="from_name" type="text" value="<?php echo esc_attr($from_name); ?>" name="from_name" />
                </div>
            ...
            <div class="setting-field">
                ...
                <div class="field-input">
                    <input id="email" placeholder="" class="from_email" type="text" value="<?php echo esc_attr($from_email); ?>" name="from_email" />
                </div>
            ...
            <div class="setting-field">
                ...
                <div class="field-input">
                    <input id="email" placeholder="" class="reply_to_email" type="text" value="<?php echo esc_attr($reply_to_email); ?>" name="reply_to_email" />
                </div>
    ...
    public function subscriber_source_metabox($post)
    {
        ...
        $source_list['csv'] = array(
            'source_title' => __('CSV', 'mail-picker'),
        );
    ...
    ?>
        ...
        <div class="settings-tabs">
            ...
            <div class="section">
                ...
                <p>Total submission: <?php echo $total_submission; ?></p>
                <p>Last submission: <?php echo $last_submission_date; ?></p>
            ...
            <div class="section">
                ...
                $args = array(
                    'id'        => 'process_status',
                    //'parent'		=> '',
                    'title'        => __('Process status?', 'mail-picker'),
                    'details'    => __('Select process status.', 'mail-picker'),
                    'type'        => 'select',
                    'value'        => $process_status,
                    'default'        => 'running',
                    'args'        => array('running' => 'Running', 'pending' => 'Pending', 'complete' => 'Completed'),
                );
    ...
    public function subscriber_source_meta_boxes_save($post_id)
    {
        ...
        $status_after_confirm = sanitize_text_field($_POST['status_after_confirm']);
        update_post_meta($post_id, 'status_after_confirm', $status_after_confirm);
        ...
        $process_status = sanitize_text_field($_POST['process_status']);
        update_post_meta($post_id, 'process_status', $process_status);
    ...
    ?>
        ...
        <ul>
            <li>
                <input style="border:none;background: beige" type="text" onclick="this.select()" value="{email}">
            ...
            <li>
                <input style="border:none;background: beige" type="text" onclick="this.select()" value="{status}">
