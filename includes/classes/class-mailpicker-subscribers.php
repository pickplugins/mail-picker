...
class Mailpicker_Subscribers
{
    ...
    public function add_subscriber($request)
    {
        ...
        $subscriber_list = isset($request['subscriber_list']) ? sanitize_text_field($request['subscriber_list']) : array();
     ...
     * @param WP_REST_Request $post_data Post data.
     */
    private function remove_subscriber($request)
    {
        $response = [];
     ...
     * @param WP_REST_Request $post_data Post data.
     */
    private function unsubscribe($request)
    {
        $response = [];
     ...
     * @param WP_REST_Request $post_data Post data.
     */
    private function confirm_subscribe($request)
    {
        $response = [];
     ...
     * @param WP_REST_Request $post_data Post data.
     */
    private function check_subscriber($request)
    {
        $response = [];
    ...
    private function mail_track_open()
    {
    ...
    private function link_click_track()
    {
