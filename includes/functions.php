...
function mail_picker_subscriber_campaign_status_column($columns)
{
    ...
    $columns['email'] = __('Mail', 'textdomain');
...
function manage_subscriber_posts_custom_column($column, $post_id)
{
...
add_action('manage_subscriber_posts_custom_column', 'manage_subscriber_posts_custom_column', 10, 2);
